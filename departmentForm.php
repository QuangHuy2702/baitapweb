                    ...
                    <table class="table mx-auto" style="width: 90%;">
                        <thead class="thead-dark" style="height:50px;">
                            <tr>
                                ...
                                <th scope="col" style="width: 18%;">MÃ NGÀNH HỌC</th>
                                <th scope="col" style="width: 27%;">TÊN NGÀNH HỌC</th>
                            ...
                            <?php
                                    ...
                                    foreach($departmentList as $department) {
                                        echo '<tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary" onclick=\'window.open("departmentInfoForm.php?id='.$department['id'].'","_self")\'>Xem danh sách</button>
                                                </td>
                                            </tr>';
                                    } 
                                ?>
