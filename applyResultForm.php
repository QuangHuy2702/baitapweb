                    ...
                    <table class="table mx-auto" style="width: 90%;">
                        <thead class="thead-dark" style="height:50px;">
                            <tr>
                                ...
                                <th scope="col" style="width: 25%;">DANH SÁCH TRÚNG TUYỂN</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                                ...
                                foreach($companyList as $company) {
                                    $sql1 = "select * from department where id = ".$company['id_department']."";
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" onclick=\'window.open("applyResultInfoForm.php?id='.$company['id'].'","_self")\'>Xem danh sách</button>
                                            </td>
                                        </tr>';
                                    } 
                                ?>
