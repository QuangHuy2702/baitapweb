                    ...
                    <table class="table mx-auto" style="width: 90%;">
                        <thead class="thead-dark" style="height:50px;">
                            <tr>
                                ...
                                <th scope="col" style="width: 18%;">MÃ LỚP HỌC</th>
                                <th scope="col" style="width: 27%;">TÊN LỚP HỌC</th>
                                <th scope="col" style="width: 23%;">NGÀNH</th>
                        ...
                        <tbody>
                            <?php
                                ...
                                foreach($classList as $class) {
                                    $sql1 = "select * from department where id = ".$class['id_department']."";
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" onclick=\'window.open("classInfoForm.php?id='.$class['id'].'","_self")\'>Xem danh sách</button>
                                            </td>
                                        </tr>';
                                    } 
                                ?>
